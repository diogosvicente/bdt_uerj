...
## Sprint MSEC 🔒 — Hardening de segurança pré-piloto (~7h) — ⏳ planejada
...
| MSEC | Hardening de segurança pré-piloto (nova, planejada) | 7 |
| **TOTAL mobile only** | | **297h** |
| Complementar Web+Mobile (estimativa) | | ~80-100h |
| **TOTAL Flutter** | | **~377-397h** |
